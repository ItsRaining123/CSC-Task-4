$('#search').keyup(function () {
    ...
    var urlForCloudImage2 = "https://res.cloudinary.com/dgwfozuot/image/upload/v1592812987/Talents/";
    ...
    $.getJSON(urlForJson, function (data) {
        ...
        $.each(data, function (key, val) {
			...
			(val.Bio.search(myExp) != -1)) {
                ...
                output += '<img src=' + urlForCloudImage2 + val.ShortName + "_tn.jpg alt=" + val.Name + '" />';
                output += '<p>' + val.Bio + '</p>';
                output += '</li>';
            }
        });
